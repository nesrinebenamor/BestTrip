...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'my_app_user.ajout.form.type' => 'getMyAppUser_Ajout_Form_TypeService',
            'my_app_user.registration.form.type' => 'getMyAppUser_Registration_Form_TypeService',
            'my_app_user.resetting.form.type' => 'getMyAppUser_Resetting_Form_TypeService',
            'my_user_provider' => 'getMyUserProviderService',
            'myapp_user.profile.form.factory' => 'getMyappUser_Profile_Form_FactoryService',
            'myapp_user.profile.form.type' => 'getMyappUser_Profile_Form_TypeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'besttrippidev23', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\MyApp\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\MyApp\\FrontBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MyApp\\UserBundle\\Entity');
        $c->addDriver($b, 'MyApp\\FrontBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('MyAppUserBundle' => 'MyApp\\UserBundle\\Entity', 'MyAppFrontBundle' => 'MyApp\\FrontBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_673a7118ca13bd6e08dacf76560ce2694c0bbe42e420de3d64770f75f8306835');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MyApp\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'MyAppUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('besttrippidev@gmail.com' => 'Admin de BestTrip.com'), 'resetting' => array('webmaster@example.com' => 'Admin de BestTrip.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'myapp_user_profile', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MyApp\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'myapp_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MyApp\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MyApp\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'MyApp\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getHwiOauth_ResourceOwner_FacebookService()
    {
        ...
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($a, $this->get('security.http_utils'), array('client_id' => '672757779502648', 'client_secret' => '502c5f639dac0c457c94acccd1308855', 'scope' => 'email', 'paths' => array(), 'options' => array()), 'facebook', new \HWI\Bundle\OAuthBundle\OAuth\RequestDataStorage\SessionStorage($this->get('session')));
    }
    ...
    /**
     * Gets the 'my_app_user.ajout.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MyApp\UserBundle\Form\Type\RegistrationFormType A MyApp\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getMyAppUser_Ajout_Form_TypeService()
    {
        return $this->services['my_app_user.ajout.form.type'] = new \MyApp\UserBundle\Form\Type\RegistrationFormType('MyApp\\UserBundle\\Entity\\Utilisateur');
    }

    /**
     * Gets the 'my_app_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MyApp\UserBundle\Form\Type\RegistrationFormType A MyApp\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getMyAppUser_Registration_Form_TypeService()
    {
        return $this->services['my_app_user.registration.form.type'] = new \MyApp\UserBundle\Form\Type\RegistrationFormType('MyApp\\UserBundle\\Entity\\Utilisateur');
    }

    /**
     * Gets the 'my_app_user.resetting.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MyApp\UserBundle\Form\Type\ResettingFormType A MyApp\UserBundle\Form\Type\ResettingFormType instance.
     */
    protected function getMyAppUser_Resetting_Form_TypeService()
    {
        return $this->services['my_app_user.resetting.form.type'] = new \MyApp\UserBundle\Form\Type\ResettingFormType('MyApp\\UserBundle\\Entity\\Utilisateur');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \MyApp\UserBundle\Security\FOSUBUserProvider A MyApp\UserBundle\Security\FOSUBUserProvider instance.
     */
    protected function getMyUserProviderService()
    {
        return $this->services['my_user_provider'] = new \MyApp\UserBundle\Security\FOSUBUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id'));
    }

    /**
     * Gets the 'myapp_user.profile.form.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MyApp\UserBundle\Form\Factory\FormFactory A MyApp\UserBundle\Form\Factory\FormFactory instance.
     */
    protected function getMyappUser_Profile_Form_FactoryService()
    {
        return $this->services['myapp_user.profile.form.factory'] = new \MyApp\UserBundle\Form\Factory\FormFactory('fos_user_profile_form');
    }

    /**
     * Gets the 'myapp_user.profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MyApp\UserBundle\Form\Type\ProfileFormType A MyApp\UserBundle\Form\Type\ProfileFormType instance.
     */
    protected function getMyappUser_Profile_Form_TypeService()
    {
        return $this->services['myapp_user.profile.form.type'] = new \MyApp\UserBundle\Form\Type\ProfileFormType('MyApp\\UserBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('/.*'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $b), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5551c4c723b56', $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($e, array('default_target_path' => '/redirect', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($e, array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.in_memory')), 'user', $c, $d), 2 => $j, 3 => $l, 4 => $n, 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5551c4c723b56', $c), 7 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, '/login'), NULL, NULL, $c));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('besttrippidev@gmail.com');
        $a->setPassword('esprittd123456789');
        $a->setAuthMode('login');
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('demo_secured_area', '/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\MyApp\\UserBundle/Resources/translations\\FOSUserBundle.en.yml'), 'en', 'FOSUserBundle');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\MyApp\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\MyApp\\FrontBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MyApp\\FrontBundle/Resources/views'), 'MyAppFront');
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 1 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('my_user_provider'), $this->get('hwi_oauth.resource_ownermap.main'), $b), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($b, 'ThisTokenIsNotSoSecretChangeIt', 'main'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5551c4c723b56'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'demo_secured_area', $c, true), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5551c4c723b56')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyAppFrontBundle' => 'MyApp\\FrontBundle\\MyAppFrontBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'besttrippidev23',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'besttrippidev@gmail.com',
            'mailer_password' => 'esprittd123456789',
            'locale' => 'en',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'debug_toolbar' => true,
            'debug_redirects' => false,
            'use_assetic_controller' => true,
            'myapp_user.emails.contact_email' => 'besttrippidev@gmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'besttrippidev@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'esprittd123456789',
            ...
            'fos_user.registration.confirmation.template' => 'MyAppUserBundle:Registration:email.txt.twig',
            'fos_user.storage' => 'orm',
            'fos_user.firewall_name' => 'main',
            'fos_user.model_manager_name' => NULL,
            'fos_user.model.user.class' => 'MyApp\\UserBundle\\Entity\\Utilisateur',
            'fos_user.profile.form.type' => 'myapp_user_profile',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'besttrippidev@gmail.com' => 'Admin de BestTrip.com',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'myapp_user_registration',
            ...
            'fos_user.resetting.email.from_email' => array(
                'webmaster@example.com' => 'Admin de BestTrip.com',
            ),
            ...
            'my_user_provider.class' => 'MyApp\\UserBundle\\Security\\FOSUBUserProvider',
