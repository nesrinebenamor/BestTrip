 ...
 */
class Utilisateur extends \MyApp\FrontBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'MyApp\\FrontBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'MyApp\\FrontBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'MyApp\\FrontBundle\\Entity\\Utilisateur' . "\0" . 'age', '' . "\0" . 'MyApp\\FrontBundle\\Entity\\Utilisateur' . "\0" . 'image', '' . "\0" . 'MyApp\\FrontBundle\\Entity\\Utilisateur' . "\0" . 'estadministrateur', 'file', 'facebookId', '' . "\0" . 'MyApp\\FrontBundle\\Entity\\Utilisateur' . "\0" . 'facebookAccessToken', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function getEstadministrateur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEstadministrateur', array());

        return parent::getEstadministrateur();
    }
    ...
    public function setEstadministrateur($estadministrateur)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEstadministrateur', array($estadministrateur));

        return parent::setEstadministrateur($estadministrateur);
    }
